...
const inherit = require('bloodline');
...
Pipeline.prototype = {
  ...
  splice(index, remove) {
    ...
    let lastIndex = index + remove;
    const streams = Array.prototype.slice.call(arguments, 2);
    ...
    const removed = this._streams.splice.apply(this._streams, [ index, remove ].concat(streams));
